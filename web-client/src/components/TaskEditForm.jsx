...
export default function TaskEditForm({ editingTask, setEditingTask, onSubmit, onCancel }) {
  return (
    <form onSubmit={onSubmit} className="bg-yellow-50 p-3 rounded-lg shadow mb-4">
      <input
      ...
      <button className="bg-green-500 text-white px-3 py-1 rounded mr-2">Зберегти</button>
